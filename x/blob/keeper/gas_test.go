	...
	testCases := []testCase{
		{
			...
			msg:             types.MsgPayForBlobs{BlobSizes: []uint32{1}, ShareVersions: []uint32{uint32(share.ShareVersionZero)}},
		...
		},
		{
			...
			msg:             types.MsgPayForBlobs{BlobSizes: []uint32{100}, ShareVersions: []uint32{uint32(share.ShareVersionZero)}},
		...
		},
		{
			...
			msg:             types.MsgPayForBlobs{BlobSizes: []uint32{1024}, ShareVersions: []uint32{uint32(share.ShareVersionZero)}},
		...
		},
		{
			...
			msg:             types.MsgPayForBlobs{BlobSizes: []uint32{1, 1, 1}, ShareVersions: []uint32{uint32(share.ShareVersionZero), uint32(share.ShareVersionZero), uint32(share.ShareVersionZero)}},
			wantGasConsumed: uint64(3 * share.ShareSize * appconsts.GasPerBlobByte), // 3 shares * 512 bytes per share * 8 gas per byte = 12288 gas
		},
		{
			name:            "3 blobs, 6 shares total",
			msg:             types.MsgPayForBlobs{BlobSizes: []uint32{1024, 800, 100}, ShareVersions: []uint32{uint32(share.ShareVersionZero), uint32(share.ShareVersionZero), uint32(share.ShareVersionZero)}},
