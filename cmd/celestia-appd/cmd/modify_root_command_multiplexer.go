...
import (
	...
	embedding "github.com/celestiaorg/celestia-app-fibre/v6/internal/embedding"
	"github.com/celestiaorg/celestia-app-fibre/v6/multiplexer/abci"
	"github.com/celestiaorg/celestia-app-fibre/v6/multiplexer/appd"
	multiplexer "github.com/celestiaorg/celestia-app-fibre/v6/multiplexer/cmd"
...
// -ldflags="-X 'github.com/celestiaorg/celestia-app-fibre/v6/cmd/celestia-appd/cmd.v2UpgradeHeight=1751707'" for arabica
// -ldflags="-X 'github.com/celestiaorg/celestia-app-fibre/v6/cmd/celestia-appd/cmd.v2UpgradeHeight=2585031'" for mocha
// -ldflags="-X 'github.com/celestiaorg/celestia-app-fibre/v6/cmd/celestia-appd/cmd.v2UpgradeHeight=2371495'" for mainnet
var v2UpgradeHeight = ""
